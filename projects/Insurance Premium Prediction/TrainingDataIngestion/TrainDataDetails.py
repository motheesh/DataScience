...
class TrainDataDetails:
    def __init__(self):
        ...
        try:
            self.TrainDbLogger.log("info"," starting initialization of Train data details")
            ...
            self.TrainDbLogger.log("info","Ending Initialization of Train data details")
        except Exception as e:
            self.TrainDbLogger.log("error",f"Error while Initializing Train data details {e}")
            

    def getQueryDetails(self):
        try:
            self.TrainDbLogger.log("info",f"Starting preparation of query details")
            ...
            self.TrainDbLogger.log("info",f"Ending preparation of query details")
        except Exception as e:
            self.TrainDbLogger.log("error",f"error during preparing query details {e}")
